...
def draw_help(helper_message: str):
    ...
    combined_image.save(os.getcwd() + f"/src/data/help/output/help_{datetime.datetime.now().strftime('%Y%m%d_%H%M%S')}.png")
    return MessageSegment.image('file:///' + os.getcwd() + f"/src/data/help/output/help_{datetime.datetime.now().strftime('%Y%m%d_%H%M%S')}.png")