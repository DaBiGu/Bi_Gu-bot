...
def _get_embedded_font(size: int) -> ImageFont:
    return get_embedded_font("Saira", "sourcehan-sans", size = size)
...
async def create_song_image(song_data: Dict[str, Any]) -> MessageSegment:
    ...
    difficulty_font = _get_embedded_font(size = 32)
    ...
    draw.text((width // 2, title_y), song_data["title"], font=_get_embedded_font(size = 48), fill=(255, 255, 255), anchor="mm")

    artist_y = title_y + 60
    draw.text((width // 2, artist_y), song_data["artist"], font=_get_embedded_font(size = 36), fill=(255, 255, 255), anchor="mm")
    ...
    draw.text((20, height - 80), f"Tip: {tip}", fill=(255, 255, 255), font=_get_embedded_font(size = 24))
    draw.text((20, height - 10), copyright_text, fill=(255, 255, 255), font=_get_embedded_font(size = 24), anchor="lb")
    draw.text((width - 20, height - 10), version_info, fill=(255, 255, 255), font=_get_embedded_font(size = 24), anchor="rb")
