...
def get_random_game_info(steamid: int, appid: int = None) -> Dict[str, Any]:
    ...
    game_steam = get_random_game(steamid, appid)
...
def draw_game_card(steamid: int, appid: int = None) -> MessageSegment:
    game_info = get_random_game_info(steamid, appid)
